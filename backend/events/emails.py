    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p style="background: #fef3c7; border-left: 4px solid #f59e0b; padding: 15px; border-radius: 6px; margin: 20px 0;">
                    <strong>⏰ Important:</strong> Please arrive 15 minutes early. 
