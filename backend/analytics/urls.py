...
## backend/analytics/api_urls.py
from django.urls import path
from . import views

urlpatterns = [
    # Minimal dashboard APIs expected by your React app
    path("metrics/totals", views.MetricsTotalsView.as_view(), name="api-metrics-totals"),
    path("attractions/top", views.TopAttractionsView.as_view(), name="api-attractions-top"),
    path("sentiment/trend", views.SentimentTrendView.as_view(), name="api-sentiment-trend"),
