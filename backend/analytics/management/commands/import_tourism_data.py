...
class Command(BaseCommand):
    ...
    def import_restaurants(self, admin_user):
        """Import 94 MAKANAN entries - Complete Official List"""
        restaurants_data = [
            # Cafes & Western
            ...
            {"name": "McDonald City Plaza", "address": "City Plaza, 15100 Alor Setar", "cuisines": ["Fast Food", "Western"], "lat": 6.1175, "lon": 100.3665, "price": "$"},
            {"name": "McDonald Alor Mengkudu", "address": "No. 8A, Jalan Alor Mengkudu 05400 Alor Setar", "cuisines": ["Fast Food", "Western"], "lat": 6.1070, "lon": 100.3870, "price": "$"},
            ...
            {"name": "Apcel Beauty & Health", "address": "No. 19, Kompleks Perniagaan Hidayah, 05350 Alor Setar", "cuisines": ["Cafe", "Health"], "lat": 6.1148, "lon": 100.3708, "price": "$$"},
            ...
            {"name": "SDR Rich Enterprise", "address": "D-11 Taman Hidayah, 05350, Alor Setar", "cuisines": ["Cafe", "Fusion"], "lat": 6.1150, "lon": 100.3710, "price": "$$"},
            {"name": "Zuspresso (M) Sdn Bhd", "address": "Kompleks Perniagaan Ampang, 05050 Alor Setar", "cuisines": ["Cafe", "Coffee"], "lat": 6.1120, "lon": 100.3710, "price": "$$"},
            {"name": "181 Coffee Shop", "address": "No. 138, Taman Saga, 05400 Alor Setar", "cuisines": ["Coffee Shop", "Malaysian"], "lat": 6.1065, "lon": 100.3865, "price": "$"},
            {"name": "Pho Su", "address": "No. 2500 Kompleks Tunku Yaakob, 05100 Alor Setar", "cuisines": ["Vietnamese", "Asian"], "lat": 6.1188, "lon": 100.3738, "price": "$$"},
            {"name": "MKMZ Semporna", "address": "Kompleks Jalan Raja, 05100 Alor Setar", "cuisines": ["Seafood", "Malaysian"], "lat": 6.1202, "lon": 100.3682, "price": "$$"},
            ...
            {"name": "Baby Egg Enterprise", "address": "21 Kompleks Perusahaan Jalan Pintu Sepuluh, 15100 Alor Setar", "cuisines": ["Cafe", "Breakfast"], "lat": 6.1145, "lon": 100.3705, "price": "$"},
            ...
            {"name": "Myviets Alor Setar", "address": "Menara Alor Setar, 05100 Alor Setar", "cuisines": ["Vietnamese", "Asian"], "lat": 6.1197, "lon": 100.3737, "price": "$$"},
            {"name": "Bravo Delight", "address": "No. 58 & 59, Jalan Istana Kuning, 05000 Alor Setar", "cuisines": ["Cafe", "Western"], "lat": 6.1206, "lon": 100.3684, "price": "$$"},
            ...
            {"name": "Casacafe", "address": "Kompleks Perusahaan Sultan Abdul Hamid, 05400 Alor Setar", "cuisines": ["Cafe", "Western"], "lat": 6.1095, "lon": 100.3895, "price": "$$"},
            {"name": "Dome Cafe", "address": "Aman Central, 05200, Alor Setar", "cuisines": ["Cafe", "Western"], "lat": 6.1196, "lon": 100.3744, "price": "$$$"},
            {"name": "Mee Hiris Istimewa", "address": "LG-31, Aman Central, 05100 Alor Setar", "cuisines": ["Malaysian", "Noodles"], "lat": 6.1193, "lon": 100.3741, "price": "$"},
            {"name": "Billion Kitchen", "address": "3K03 Aman Central, 05100 Alor Setar", "cuisines": ["Chinese", "Asian"], "lat": 6.1195, "lon": 100.3743, "price": "$$"},
            {"name": "Ichiban Ramen", "address": "LG-23, Aman Central, 05100 Alor Setar", "cuisines": ["Japanese", "Ramen"], "lat": 6.1192, "lon": 100.3739, "price": "$$"},
            {"name": "HWC Coffee", "address": "G-66, Aman Central, 05100 Alor Setar", "cuisines": ["Coffee", "Cafe"], "lat": 6.1198, "lon": 100.3745, "price": "$$"},
            ...
            {"name": "Teik Jue Kopitiam", "address": "No. 494, Taman Sri Ampang, 05050 Alor Setar", "cuisines": ["Coffee Shop", "Malaysian"], "lat": 6.1122, "lon": 100.3712, "price": "$"},
            {"name": "Al Ikhwan Sushi", "address": "Menara Alor Setar, 05100 Alor Setar", "cuisines": ["Japanese", "Sushi"], "lat": 6.1199, "lon": 100.3739, "price": "$$"},
            {"name": "Snow Cafe", "address": "48 Jalan Putra, 05100, Alor Setar", "cuisines": ["Cafe", "Dessert"], "lat": 6.1169, "lon": 100.3664, "price": "$$"},
            {"name": "Restoran Lagenda D'Muar", "address": "No 242, Kawasan Perusahaan Tandop, 05400 Alor Setar", "cuisines": ["Malaysian", "Muar Cuisine"], "lat": 6.1090, "lon": 100.3890, "price": "$$"},
            ...
            {"name": "Restoran Ho Zui", "address": "B-145, Taman Perindustrian Tandop Utama, 05400 Alor Setar", "cuisines": ["Chinese", "Dim Sum"], "lat": 6.1087, "lon": 100.3887, "price": "$$"},
            {"name": "Hayashi Ramen", "address": "12 Jalan Penjara Lama, 05000 Alor Setar", "cuisines": ["Japanese", "Ramen"], "lat": 6.1210, "lon": 100.3690, "price": "$$"},
            {"name": "Joyful Honey Restaurant", "address": "57, Taman Perindustrian Ringan Kristal, 05150 Alor Setar", "cuisines": ["Chinese", "Fusion"], "lat": 6.1328, "lon": 100.3628, "price": "$$"},
            {"name": "NZL Delicious Centre", "address": "410 Jalan Pintu Sepulu, 05150 Alor Setar", "cuisines": ["Malaysian", "Mixed"], "lat": 6.1147, "lon": 100.3707, "price": "$$"},
            {"name": "Bangkok Shabu and Grilled", "address": "No. 9 Taman Takwa, 05460 Alor Setar", "cuisines": ["Thai", "BBQ"], "lat": 6.1425, "lon": 100.3835, "price": "$$"},
            {"name": "Restu Selera Kampung", "address": "No.109, Kompleks Sultan Abdul Hamid, 05050 Alor Setar", "cuisines": ["Malaysian", "Traditional"], "lat": 6.1197, "lon": 100.3677, "price": "$"},
            {"name": "Dania Tomyam Seafood", "address": "138, Kompleks Shahab Perdana, 05150 Alor Setar", "cuisines": ["Thai", "Seafood"], "lat": 6.1324, "lon": 100.3644, "price": "$$"},
            ...
            {"name": "De Baroqah Bistro", "address": "Batu 12 ¼ Jalan Naka, 06400 Alor Setar", "cuisines": ["Cafe", "Bistro"], "lat": 6.1920, "lon": 100.4220, "price": "$$"},
            {"name": "XP3 Cafe", "address": "A26 Taman Bandar Baru Mergong, 05150 Alor Setar", "cuisines": ["Cafe", "Western"], "lat": 6.1342, "lon": 100.3612, "price": "$$"},
            {"name": "P10 Steamboat & Grill", "address": "No. 12, Jalan Tengah, 05100 Alor Setar", "cuisines": ["Steamboat", "BBQ"], "lat": 6.1173, "lon": 100.3669, "price": "$$"},
            ...
            {"name": "Restoran Pak Wang Thai Food", "address": "No. 240, Taman Anggerik, 05400 Alor Setar", "cuisines": ["Thai", "Asian"], "lat": 6.1085, "lon": 100.3885, "price": "$$"},
            {"name": "Night Devine Cafe", "address": "55, Pusat Perdagangan Tuanku Haminah, 05100 Alor Setar", "cuisines": ["Cafe", "Western"], "lat": 6.1176, "lon": 100.3666, "price": "$$"},
            {"name": "Kedai Kopi 799 Kim Penuh", "address": "28 Medan Putra Fasa 2, 05150 Alor Setar", "cuisines": ["Coffee Shop", "Chinese"], "lat": 6.1166, "lon": 100.3662, "price": "$"},
            {"name": "Mookata BBQ & Steamboat", "address": "169 E, Jalan Kampung Perak, 05100 Alor Setar", "cuisines": ["Thai", "BBQ"], "lat": 6.1201, "lon": 100.3671, "price": "$$"},
            {"name": "Hwa Ren Jie Restaurant", "address": "No. 50, Jalan Putra, 05150 Alor Setar", "cuisines": ["Chinese", "Asian"], "lat": 6.1167, "lon": 100.3661, "price": "$$"},
            {"name": "WG Sweety House Cafe", "address": "1A, Jalan Menanti, 05100 Alor Setar", "cuisines": ["Cafe", "Dessert"], "lat": 6.1177, "lon": 100.3667, "price": "$$"},
            {"name": "Duckteow", "address": "No. 6, Plaza Mentaloon, 06650 Alor Setar", "cuisines": ["Chinese", "Duck"], "lat": 6.1163, "lon": 100.3723, "price": "$$"},
            {"name": "Red Bubble Tea Cafe", "address": "36, Kompleks Sultan Abdul Hamid, 05050 Alor Setar", "cuisines": ["Cafe", "Bubble Tea"], "lat": 6.1196, "lon": 100.3676, "price": "$"},
            {"name": "Prosper City Restaurant", "address": "A6 Taman Bandar Baru Mergong, 05150 Alor Setar", "cuisines": ["Chinese", "Dim Sum"], "lat": 6.1340, "lon": 100.3610, "price": "$$"},
            {"name": "Nasi Kandar Mamu Thai", "address": "No. 11, Lorong Putih 9, 05150 Alor Setar", "cuisines": ["Indian", "Nasi Kandar"], "lat": 6.1302, "lon": 100.3652, "price": "$"},
            {"name": "Niceman Restaurant", "address": "1470 Taman Sultan Badlishah, 05050 Alor Setar", "cuisines": ["Chinese", "Asian"], "lat": 6.1119, "lon": 100.3709, "price": "$$"},
            {"name": "JNH Cafe", "address": "No. 89 Jalan Pekan Cina, 05000 Alor Setar", "cuisines": ["Cafe", "Local"], "lat": 6.1237, "lon": 100.3607, "price": "$$"},
            {"name": "Galaxy Sky Kitchen", "address": "B-117 Taman Perindustrian Tandop Utama, 05400 Alor Setar", "cuisines": ["Chinese", "Asian"], "lat": 6.1086, "lon": 100.3886, "price": "$$"},
            {"name": "Morning Choo Yee Kopitiam", "address": "645 Taman Derga Jaya, 05300 Alor Setar", "cuisines": ["Coffee Shop", "Malaysian"], "lat": 6.1278, "lon": 100.3518, "price": "$"},
            {"name": "Restoran Sin Hong Kheng", "address": "9, Jalan Menanti, 05100 Alor Setar", "cuisines": ["Chinese", "Asian"], "lat": 6.1178, "lon": 100.3668, "price": "$$"},
            {"name": "Restoran Abang Gangsa", "address": "No 402-A, Jalan Sekerat, 05100 Alor Setar", "cuisines": ["Malaysian", "Local"], "lat": 6.1171, "lon": 100.3666, "price": "$"},
            {"name": "Sapina Restaurant", "address": "No. 1 & 2 Bangunan Ukir, 05200 Alor Setar", "cuisines": ["Malaysian", "Fusion"], "lat": 6.1181, "lon": 100.3761, "price": "$$"},
            {"name": "The Rhythmic Sky Cafe", "address": "10, Jalan Pintu Sepuluh, 05100, Alor Setar", "cuisines": ["Cafe", "Western"], "lat": 6.1146, "lon": 100.3706, "price": "$$"},
            {"name": "Bayu Delight Food & Beverage", "address": "No. 65, 66, 67, Pekan Simpang Kuala, 05400 Alor Setar", "cuisines": ["Malaysian", "Mixed"], "lat": 6.1078, "lon": 100.3878, "price": "$$"},
            {"name": "Nine Dishes Corner", "address": "B-166, Taman Perindustrian Tandop Utama, 05400 Alor Setar", "cuisines": ["Chinese", "Asian"], "lat": 6.1089, "lon": 100.3889, "price": "$$"},
            {"name": "Restoran Sin Hai Yin", "address": "21-A Kompleks Sukan Muazam Shah, 05400 Alor Setar", "cuisines": ["Chinese", "Dim Sum"], "lat": 6.1082, "lon": 100.3882, "price": "$$"},
            {"name": "Hungry Hunter", "address": "No. 37, Taman Mergong Indah, 05150 Alor Setar", "cuisines": ["Western", "Fusion"], "lat": 6.1335, "lon": 100.3605, "price": "$$$"},
            {"name": "Kedai Makan Nian Xiang", "address": "50, Taman Johan Fasa 2, 06600 Alor Setar", "cuisines": ["Chinese", "Asian"], "lat": 6.0980, "lon": 100.3350, "price": "$"},
            {"name": "Old Taste Nyonya House", "address": "B 143, Taman Perindustrian Tandop Utama, 05400 Alor Setar", "cuisines": ["Nyonya", "Malaysian"], "lat": 6.1088, "lon": 100.3888, "price": "$$"},
            {"name": "Eza Thai Restaurant", "address": "No. 275 & 274, Kompleks Perniagaan Anggerik, 05050 Alor Setar", "cuisines": ["Thai", "Asian"], "lat": 6.1117, "lon": 100.3707, "price": "$$"},
            {"name": "Asiatic Thai Cuisine", "address": "No 17 & 18, Kompleks Perniagaan Long Island, 05150 Alor Setar", "cuisines": ["Thai", "Asian"], "lat": 6.1318, "lon": 100.3638, "price": "$$"},
            {"name": "Mateen Cafe", "address": "126, Taman Tunku Hosna, 05300 Alor Setar", "cuisines": ["Cafe", "Western"], "lat": 6.1265, "lon": 100.3525, "price": "$$"},
            {"name": "Summer Food Corner", "address": "No. 55, Kompleks MHJ, 06600 Alor Setar", "cuisines": ["Malaysian", "Mixed"], "lat": 6.0975, "lon": 100.3345, "price": "$"},
            {"name": "Syukran Seafood", "address": "246-B, Titi Gajah, Alor Setar", "cuisines": ["Seafood", "Malaysian"], "lat": 6.1425, "lon": 100.3835, "price": "$$"},
            {"name": "LimKopi 87 Restaurant", "address": "No 2148 A, Taman Abd Aziz, 05050 Alor Setar", "cuisines": ["Coffee Shop", "Malaysian"], "lat": 6.1115, "lon": 100.3705, "price": "$"},
            {"name": "Corner Coffee Shop", "address": "No. 6-A, Jalan Tunku Abdul Halim, 05150 Alor Setar", "cuisines": ["Coffee Shop", "Local"], "lat": 6.1174, "lon": 100.3668, "price": "$"},
            {"name": "Asmani Tomyam 2", "address": "No. 211 Komp. Sultan Abd Hamid, 05050 Alor Setar", "cuisines": ["Thai", "Tomyam"], "lat": 6.1198, "lon": 100.3678, "price": "$"},
            {"name": "Sahabat Corner Enterprise", "address": "No. 6A, Taman Desa Aman, 05150 Alor Setar", "cuisines": ["Malaysian", "Local"], "lat": 6.1301, "lon": 100.3651, "price": "$"},
            {"name": "Nasi Lemak Pekan Cina", "address": "73, Pekan Cina, 05000 Alor Setar", "cuisines": ["Malaysian", "Nasi Lemak"], "lat": 6.1236, "lon": 100.3606, "price": "$"},
            {"name": "Che Siah Tomyam", "address": "404 A, Jalan Sekerat, 05150 Alor Setar", "cuisines": ["Thai", "Tomyam"], "lat": 6.1170, "lon": 100.3665, "price": "$"},
            {"name": "Saiful Tomyam", "address": "No. 5-A, Jalan Sungai Korok, 05400 Alor Setar", "cuisines": ["Thai", "Tomyam"], "lat": 6.1060, "lon": 100.3860, "price": "$"},
            {"name": "Nasi Royale Jalil", "address": "9, Plaza Mentaloon, 05250 Alor Setar", "cuisines": ["Malaysian", "Nasi"], "lat": 6.1164, "lon": 100.3724, "price": "$"},
            {"name": "Boost", "address": "LG-02, Aman Central, 05100 Alor Setar", "cuisines": ["Juice", "Beverages"], "lat": 6.1191, "lon": 100.3738, "price": "$"},
            {"name": "4 Fingers Malaysia", "address": "Lot 16A, Kompleks Perniagaan Ampang, 05050 Alor Setar", "cuisines": ["Fast Food", "Chicken"], "lat": 6.1121, "lon": 100.3711, "price": "$$"},
            {"name": "Gigi Coffee", "address": "4-K06, Aman Central, 05100 Alor Setar", "cuisines": ["Coffee", "Cafe"], "lat": 6.1197, "lon": 100.3746, "price": "$$"},
            {"name": "Gongcha Cafe", "address": "LG-05, Aman Central, 05100 Alor Setar", "cuisines": ["Bubble Tea", "Cafe"], "lat": 6.1190, "lon": 100.3737, "price": "$"},
            {"name": "Empire Sushi", "address": "LK-K01, Aman Central, 05100 Alor Setar", "cuisines": ["Japanese", "Sushi"], "lat": 6.1194, "lon": 100.3741, "price": "$$"},
            {"name": "CG Tea", "address": "G-61 & G-73, Aman Central, 05100 Alor Setar", "cuisines": ["Bubble Tea", "Beverages"], "lat": 6.1195, "lon": 100.3742, "price": "$"},
            {"name": "Krispy Kreme Doughnuts", "address": "3829 Jalan Sultanah, 05350 Alor Setar", "cuisines": ["Bakery", "Doughnuts"], "lat": 6.1149, "lon": 100.3709, "price": "$$"},
            {"name": "Peladang Mart", "address": "4049 Taman Mutiara, 05350 Alor Setar", "cuisines": ["Malaysian", "Local"], "lat": 6.1151, "lon": 100.3711, "price": "$"},
        ]
