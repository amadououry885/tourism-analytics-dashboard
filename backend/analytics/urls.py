...
urlpatterns = [
    ...
    path("metrics/engagement", views.MetricsEngagementView.as_view(), name="metrics-engagement"),
    ...
    # ✅ NEW: API alias for Engagement totals
    path("api/metrics/engagement", views.MetricsEngagementView.as_view(), name="api-metrics-engagement"),
]
